...
namespace spero::compiler::ast {
	...
	OutStream BasicBinding::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream QualifiedBinding::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream Variable::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream AssignName::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream AssignTuple::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	 ...
	 * ast::Pattern
	 */
	OutStream Pattern::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream PTuple::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream PNamed::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream PAdt::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream PVal::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
