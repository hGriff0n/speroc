...
namespace spero::compiler::ast {
	...
	OutStream Annotation::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream TypeGeneric::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream ValueGeneric::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream Case::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	 ...
	 * ast::ImporPiece
	 */
	OutStream ImportPiece::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream ImportName::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream ImportGroup::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
	...
	OutStream Adt::prettyPrint(OutStream s, size_t buf) {
		return s;
	}
